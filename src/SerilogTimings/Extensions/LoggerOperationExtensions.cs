...
namespace SerilogTimings.Extensions
{
    ...
    public static class LoggerOperationExtensions
    {
        ...
        /// <returns>An <see cref="Operation"/> object.</returns>
        [MessageTemplateFormatMethod("messageTemplate")]
        public static IDisposable TimeOperation(this ILogger logger, string messageTemplate, Func<TimeSpan, string> timeTransform, params object[] args)
        {
            return new Operation(logger, messageTemplate, args, CompletionBehaviour.Complete, LogEventLevel.Information,
                LogEventLevel.Warning, timeTransform: timeTransform);
        }
        ...
        /// <returns>An <see cref="Operation"/> object.</returns>
        [MessageTemplateFormatMethod("messageTemplate")]
        public static Operation BeginOperation(this ILogger logger, string messageTemplate, Func<TimeSpan, string> timeTransform, params object[] args)
        {
            return new Operation(logger, messageTemplate, args, CompletionBehaviour.Abandon, LogEventLevel.Information, LogEventLevel.Warning, timeTransform: timeTransform);
        }
        ...
        public static LevelledOperation OperationAt(this ILogger logger, LogEventLevel completion, LogEventLevel? abandonment = null, TimeSpan? warningThreshold = null, Func<TimeSpan, string>? timeTransform = null)
        {
            ...
            return new LevelledOperation(logger, completion, appliedAbandonment, warningThreshold, timeTransform);
        }
    }
}
